    ...
    >
      <div className="flex flex-col md:flex-row md:flex-nowrap gap-6 md:gap-12">
        ...
        <div className="w-full md:w-7/12 flex flex-col gap-6 md:gap-12">
          <div className="squircle squircle-7xl squircle-smooth-xl squircle-[#1E1E1E] p-8 md:p-16 text-[#424242] flex-1">
            <Image
              src="/Lock.svg"
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-12">
            <div className="squircle squircle-7xl squircle-smooth-xl squircle-[#1E1E1E] p-8 md:p-16 text-[#424242] w-full md:w-1/2">
              <Image
        ...
        <div className="w-full md:w-5/12 flex flex-col gap-6 md:gap-12">
          ...
          <div className="squircle squircle-7xl squircle-smooth-xl squircle-[#1E1E1E] p-8 md:p-16 text-[#424242]">
            <Image
              src="/path14.svg"
              alt="Savings Options Icon"
              width={48}
