    ...
    <div className="flex w-[327px] p-6 flex-col items-start gap-[18px] squircle squircle-[36px] squircle-smooth-xl squircle-[#1A1A1A] text-white">
      ...
      <div className="flex p-3 items-start gap-[10px] self-stretch squircle squircle-[18px] squircle-smooth-xl squircle-[#252525]">
        <div className="flex p-2 justify-center items-center squircle squircle-[6px] squircle-smooth-xl squircle-[#08F]">
          <Image src="/white-lock.svg" alt="Locked Vault" width={72} height={72} />
        </div>
        <div className="flex flex-col">
          <h3 className="text-lg font-medium">Locked Vault</h3>
          <p className="text-sm text-gray-400">
            Deposit, set how much you want to receive, when and where. You
            can't break this vault or your rules, can only change the payout
            wallet or account, <a href="#" className="text-blue-400">learn more</a>
          </p>
        </div>
      </div>
      ...
      <div className="flex p-3 items-start gap-[10px] self-stretch squircle squircle-[18px] squircle-smooth-xl squircle-[#252525]">
        ...
        <div className="flex flex-col">
          ...
          <p className="text-sm text-gray-400">
            ...
            break fee, <a href="#" className="text-blue-400">learn more</a>
          </p>
        </div>
      </div>
      ...
      <div className="flex p-3 items-start gap-[10px] self-stretch squircle squircle-[18px] squircle-smooth-xl squircle-[#252525]">
        <div className="flex p-2 justify-center items-center squircle squircle-[6px] squircle-smooth-xl squircle-[#FF692C]">
          <Image src="/target.svg" alt="Target Savings" width={72} height={72} />
        </div>
        <div className="flex flex-col">
